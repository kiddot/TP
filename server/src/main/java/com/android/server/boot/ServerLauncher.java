...
import static com.android.server.tools.config.CC.mp.net.tcpGateway;
import static com.android.server.tools.config.CC.mp.net.udpGateway;
import static com.android.server.tools.config.CC.mp.net.wsEnabled;
import static com.google.common.base.Ascii.GS;
...
public final class ServerLauncher {
    ...
    public ServerLauncher() {
        chain.boot()
                ...
                .setNext(() -> new ServerBoot(GatewayServer.I()), tcpGateway())//6.启动tcp网关服务
