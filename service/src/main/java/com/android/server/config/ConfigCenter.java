...
public class ConfigCenter {
    ...
    public static int session_expired_time;
    public static int max_heartbeat;
    public static int max_packet_size;
    public static int min_heartbeat;
    public static long compress_threshold;
    public static int max_hb_timeout_times;
    public static int connect_server_port;
    public static int gateway_server_port;
    public static int admin_server_port;
    public static int gateway_client_port;
